...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'registration_otp_hint': 'Enter 4-digit OTP sent to phone',
    ...
    'mr': {
      ...
      'registration_otp_hint': 'फोनवर पाठवलेला 4-अंकी ओटीपी प्रविष्ट करा',
    ...
    'hi': {
      ...
      'registration_otp_hint': 'फ़ोन पर भेजा गया 4-अंकीय ओटीपी दर्ज करें',
