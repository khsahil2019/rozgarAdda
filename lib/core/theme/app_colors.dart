...
class NewAppColors extends ThemeExtension<NewAppColors> {
  ...
  final Color secondarygradient1 = const Color.fromARGB(255, 250, 221, 208);
  final Color secondarygradient2 = const Color.fromARGB(255, 221, 246, 255);
  final Color organgeIconLight = const Color(0xFFFF6B36);
  final Color organgeIconbg = const Color(0xFFFFF0EB);
  ...
  static const dark = NewAppColors(
    ...
    fieldBg: Color(0xFF1E1E1E), // Dark input background
  ...
  static const light = NewAppColors(
    brandColor: Color(0xFF1400FF),
    textPrimary: Color(0xFF1A1A2E),
    textSecondary: Color(0xFF8A8FA3),
    textTertiary: Color(0xFF8A8FA3),
    textDisabled: Color(0xFFD0D5F5),
    textHint: Color(0xFF8A8FA3),
    textPlaceholder: Color(0xFF8A8FA3),
    textLink: Color(0xFF1400FF),
    textInverse: Color(0xFFFFFFFF),
    textOnBrand: Color(0xFFFFFFFF),
    background: Color(0xFFFFFFFF),
    surface: Color(0xFFFFFFFF),
    divider: Color(0xFFEAEAF8),
    border: Color(0xFFD0D5F5),
    error: Color(0xFFD32F2F),
    success: Color(0xFF388E3C),
    warning: Color(0xFFFFCC00),
    info: Color(0xFF1400FF),
    iconPrimary: Color(0xFF1A1A2E),
    gradientOne: Color(0xFF1400FF),
    gradientTwo: Color(0xFF1400FF),
    badgeAttendance: Color(0xFF1400FF),
    badgePoints: Color(0xFFFFCC00),
    badgeRank: Color(0xFFFFCC00),
    fieldBg: Color(0xFFF7F8FF),
    blueIconBg: Color(0xFFEAEAF8), // lightLavender
    blueIcon: Color(0xFF1400FF), // primaryBlue
    yellowIconBg: Color(0x1AFFCC00), // 10% accentYellow
    yellowIcon: Color(0xFFFFCC00), // accentYellow
    orangeCardBg: Color(0xFFFFF3E0),
    orangeIconBg: Color(0xFFFFCC80),
    orangeIcon: Color(0xFFE65100),
    ...
    attendanceLate: Color(0xFFFFCC00),
    attendanceLateBg: Color(0x1AFFCC00),
    attendanceCancelled: Color(0xFFEF6C00),
    attendanceCancelledBg: Color(0xFFFFF3E0),
    attendanceTrial: Color(0xFF1400FF),
    attendanceTrialBg: Color(0xFFEAEAF8),
    purpleIcon: Color(0xFF8E24AA),
    purpleIconBg: Color(0xFFF3E5F5),
    purpleTagBg: Color(0xFFF3E5F5),
    orangeTagBg: Color(0xFFFFF3E0),
    greenTagBg: Color(0xFFE8F5E9),
    blueTagBg: Color(0xFFEAEAF8),
    highPriority: Color(0xFFD32F2F),
    mediumPriority: Color(0xFFFFCC00),
